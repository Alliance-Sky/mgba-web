...
export default function CustomControlsOverlay({ 
  ...
  return (
    <>
      <DraggableControl key={getLayoutId('dpad')} id={getLayoutId('dpad')} position={getPos('dpad')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
        <div className="dpad">
      ...
      <DraggableControl key={getLayoutId('ab')} id={getLayoutId('ab')} position={getPos('ab')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
      ...
      <DraggableControl key={getLayoutId('l')} id={getLayoutId('l')} position={getPos('l')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
        <button className="bumper-btn bumper-l" data-gba-btn="L" style={{ pointerEvents: 'auto' }}>L</button>
      </DraggableControl>

      <DraggableControl key={getLayoutId('r')} id={getLayoutId('r')} position={getPos('r')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
        <button className="bumper-btn bumper-r" data-gba-btn="R" style={{ pointerEvents: 'auto' }}>R</button>
      </DraggableControl>

      <DraggableControl key={getLayoutId('select')} id={getLayoutId('select')} position={getPos('select')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
      ...
      <DraggableControl key={getLayoutId('menu')} id={getLayoutId('menu')} position={getPos('menu')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
        <div className="sys-btn-wrapper" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <DraggableControl key={getLayoutId('start')} id={getLayoutId('start')} position={getPos('start')} onPositionChange={onPositionChange} isEditMode={isEditMode}>
        <div className="sys-btn-wrapper" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
